...
ylim <- c(0.5, 100)
par(
  mfrow = c(1, 3), oma = c(4, 0, 0, 0) + 0.1, mar = c(0.5, 2, 2, 1),
...
par(
  mfrow = c(1, 3), oma = c(4, 3, 0, 0) + 0.1, mar = c(0.5, 2, 2, 1),
  xpd = NA, cex = 1.2, cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.3
)

plot_BNPR(res_BNPR,
  traj = traj1, ylim = ylim, lwd = 3,
...
arrows(
  x0 = 12, y0 = 40, x1 = 3, y1 = 22, length = 0.1, lwd = 2,
  col = trev_purp
)
```
